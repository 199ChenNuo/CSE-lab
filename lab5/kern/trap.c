...
trap_init(void)
{
	...
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_spurious_handler, 0);

	extern void irq_8_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_8_handler, 0);

	extern void irq_9_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_9_handler, 0);

	extern void irq_10_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_10_handler, 0);

	extern void irq_11_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_11_handler, 0);

	extern void irq_12_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_12_handler, 0);

	extern void irq_13_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_13_handler, 0);

	extern void irq_ide_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_ide_handler, 0);

	extern void irq_15_handler();
	SETGATE(idt[IRQ_OFFSET+5], 0, GD_KT, irq_15_handler, 0);
