...
sys_env_destroy(envid_t envid)
{
  ...
  800112:	68 2a 11 80 00       	push   $0x80112a
  800117:	6a 4c                	push   $0x4c
  800119:	68 47 11 80 00       	push   $0x801147
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800193:	68 2a 11 80 00       	push   $0x80112a
  800198:	6a 4c                	push   $0x4c
  80019a:	68 47 11 80 00       	push   $0x801147
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d5:	68 2a 11 80 00       	push   $0x80112a
  8001da:	6a 4c                	push   $0x4c
  8001dc:	68 47 11 80 00       	push   $0x801147
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800217:	68 2a 11 80 00       	push   $0x80112a
  80021c:	6a 4c                	push   $0x4c
  80021e:	68 47 11 80 00       	push   $0x801147
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800259:	68 2a 11 80 00       	push   $0x80112a
  80025e:	6a 4c                	push   $0x4c
  800260:	68 47 11 80 00       	push   $0x801147
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80029b:	68 2a 11 80 00       	push   $0x80112a
  8002a0:	6a 4c                	push   $0x4c
  8002a2:	68 47 11 80 00       	push   $0x801147
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002dd:	68 2a 11 80 00       	push   $0x80112a
  8002e2:	6a 4c                	push   $0x4c
  8002e4:	68 47 11 80 00       	push   $0x801147
...
sys_ipc_recv(void *dstva)
{
  ...
  800341:	68 2a 11 80 00       	push   $0x80112a
  800346:	6a 4c                	push   $0x4c
  800348:	68 47 11 80 00       	push   $0x801147
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003af:	56                   	push   %esi
  8003b0:	50                   	push   %eax
  8003b1:	68 58 11 80 00       	push   $0x801158
  ...
  8003c2:	e8 56 00 00 00       	call   80041d <vcprintf>
	cprintf("\n");
  8003c7:	c7 04 24 7b 11 80 00 	movl   $0x80117b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80054c:	0f be 80 7d 11 80 00 	movsbl 0x80117d(%eax),%eax
  800553:	50                   	push   %eax
...
0080059b <vprintfmt>:
{
  ...
  8006db:	52                   	push   %edx
  8006dc:	68 9e 11 80 00       	push   $0x80119e
  8006e1:	53                   	push   %ebx
  8006e2:	56                   	push   %esi
  ...
  8006f3:	50                   	push   %eax
  8006f4:	68 95 11 80 00       	push   $0x801195
  8006f9:	53                   	push   %ebx
  8006fa:	56                   	push   %esi
  ...
  80071b:	b8 8e 11 80 00       	mov    $0x80118e,%eax
  ...
  800a83:	68 ec 12 80 00       	push   $0x8012ec
  800a88:	68 9e 11 80 00       	push   $0x80119e
  800a8d:	53                   	push   %ebx
  800a8e:	56                   	push   %esi
  ...
  800a9f:	68 b4 12 80 00       	push   $0x8012b4
  800aa4:	68 9e 11 80 00       	push   $0x80119e
  800aa9:	53                   	push   %ebx
  800aaa:	56                   	push   %esi
