	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021c:	0f be 80 48 11 80 00 	movsbl 0x801148(%eax),%eax
  800223:	50                   	push   %eax
...
0080026b <vprintfmt>:
{
  ...
  8002c5:	ff 24 85 20 13 80 00 	jmp    *0x801320(,%eax,4)
  ...
  8003a0:	8b 14 85 80 14 80 00 	mov    0x801480(,%eax,4),%edx
  8003a7:	85 d2                	test   %edx,%edx
  8003a9:	74 18                	je     8003c3 <vprintfmt+0x158>
				printfmt(putch, putdat, "%s", p);
  8003ab:	52                   	push   %edx
  8003ac:	68 69 11 80 00       	push   $0x801169
  8003b1:	53                   	push   %ebx
  8003b2:	56                   	push   %esi
  ...
  8003c3:	50                   	push   %eax
  8003c4:	68 60 11 80 00       	push   $0x801160
  8003c9:	53                   	push   %ebx
  8003ca:	56                   	push   %esi
  ...
  8003eb:	b8 59 11 80 00       	mov    $0x801159,%eax
  ...
  800753:	68 b8 12 80 00       	push   $0x8012b8
  800758:	68 69 11 80 00       	push   $0x801169
  80075d:	53                   	push   %ebx
  80075e:	56                   	push   %esi
  ...
  80076f:	68 80 12 80 00       	push   $0x801280
  800774:	68 69 11 80 00       	push   $0x801169
  800779:	53                   	push   %ebx
  80077a:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800c07:	68 c0 14 80 00       	push   $0x8014c0
  800c0c:	6a 4c                	push   $0x4c
  800c0e:	68 dd 14 80 00       	push   $0x8014dd
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c88:	68 c0 14 80 00       	push   $0x8014c0
  800c8d:	6a 4c                	push   $0x4c
  800c8f:	68 dd 14 80 00       	push   $0x8014dd
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cca:	68 c0 14 80 00       	push   $0x8014c0
  800ccf:	6a 4c                	push   $0x4c
  800cd1:	68 dd 14 80 00       	push   $0x8014dd
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d0c:	68 c0 14 80 00       	push   $0x8014c0
  800d11:	6a 4c                	push   $0x4c
  800d13:	68 dd 14 80 00       	push   $0x8014dd
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d4e:	68 c0 14 80 00       	push   $0x8014c0
  800d53:	6a 4c                	push   $0x4c
  800d55:	68 dd 14 80 00       	push   $0x8014dd
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d90:	68 c0 14 80 00       	push   $0x8014c0
  800d95:	6a 4c                	push   $0x4c
  800d97:	68 dd 14 80 00       	push   $0x8014dd
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dd2:	68 c0 14 80 00       	push   $0x8014c0
  800dd7:	6a 4c                	push   $0x4c
  800dd9:	68 dd 14 80 00       	push   $0x8014dd
...
sys_ipc_recv(void *dstva)
{
  ...
  800e36:	68 c0 14 80 00       	push   $0x8014c0
  800e3b:	6a 4c                	push   $0x4c
  800e3d:	68 dd 14 80 00       	push   $0x8014dd
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ea4:	56                   	push   %esi
  800ea5:	50                   	push   %eax
  800ea6:	68 ec 14 80 00       	push   $0x8014ec
  ...
  800eb7:	e8 31 f2 ff ff       	call   8000ed <vcprintf>
	cprintf("\n");
  800ebc:	c7 04 24 3c 11 80 00 	movl   $0x80113c,(%esp)
