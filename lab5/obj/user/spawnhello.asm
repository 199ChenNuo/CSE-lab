...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 84 24 80 00       	push   $0x802484
  80006f:	6a 09                	push   $0x9
  800071:	68 9c 24 80 00       	push   $0x80249c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f2:	56                   	push   %esi
  8000f3:	50                   	push   %eax
  8000f4:	68 b8 24 80 00       	push   $0x8024b8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	0f be 80 db 24 80 00 	movsbl 0x8024db(%eax),%eax
  800296:	50                   	push   %eax
...
008002de <vprintfmt>:
{
  ...
  800436:	50                   	push   %eax
  800437:	68 f3 24 80 00       	push   $0x8024f3
  80043c:	53                   	push   %ebx
  80043d:	56                   	push   %esi
  ...
  80045e:	b8 ec 24 80 00       	mov    $0x8024ec,%eax
  ...
  8007c6:	68 48 26 80 00       	push   $0x802648
  ...
  8007e2:	68 10 26 80 00       	push   $0x802610
