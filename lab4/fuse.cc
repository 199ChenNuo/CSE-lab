...
{
    std::cout << "=============== fuseserver_createhelper(parent:" 
    ...
    printf("end of fuseserver_createhelper()\n\n");
    return ret;
}
        ...
        mode_t mode, struct fuse_file_info *fi)
{
    ...
    yfs_client::status ret;
    // std::cout << "=============== fuseserver_create(parent: " << parent << ", name: " << name << ") ===============" << std::endl;
...
void fuseserver_mknod( fuse_req_t req, fuse_ino_t parent, 
    ...
    struct fuse_entry_param e;
    yfs_client::status ret;
    std::cout << "=============== fuseserver_mknod(parent: " << parent << ", name: " << name << ") ===============" << std::endl;
    if( (ret = fuseserver_createhelper( parent, name, mode, &e, extent_protocol::T_FILE)) == yfs_client::OK ) {
